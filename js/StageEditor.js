...
var $author$project$StageEditor$OnUriEncoded = function (a) {
	return {$: 'OnUriEncoded', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $author$project$Ports$onUriEncoded = _Platform_incomingPort('onUriEncoded', $elm$json$Json$Decode$string);
var $author$project$StageEditor$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Ports$onUriEncoded($author$project$StageEditor$OnUriEncoded)
			]));
};
...
var $author$project$Stage$put = F4(
	function (x, y, maybe, stage) {
		var map = function () {
			if (maybe.$ === 'Nothing') {
				return A2(
...
var $author$project$Stage$toString = function (stage) {
	var _v0 = stage.size;
	var width = _v0.a;
	var height = _v0.b;
			...
			case 'StageClicked':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{stage: newStage}),
					$author$project$Ports$encodeUri(
						$author$project$Stage$toString(newStage)));
			default:
				var encoded = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromInt(chipOffsetX * $author$project$Object$chipSize)),
					$elm$svg$Svg$Attributes$y(
					$elm$core$String$fromInt(chipOffsetY * $author$project$Object$chipSize)),
					$elm$svg$Svg$Attributes$width(
					$elm$core$String$fromInt($author$project$Object$chipSize)),
					$elm$svg$Svg$Attributes$height(
					$elm$core$String$fromInt($author$project$Object$chipSize)),
					$elm$svg$Svg$Attributes$stroke('none'),
					$elm$svg$Svg$Attributes$fill('#00000010'),
					$elm$svg$Svg$Events$onMouseDown(msg),
...
var $author$project$StageEditor$editableStageView = function (stage) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
...
var $author$project$StageEditor$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$StageEditor$editableStageView(model.stage),
				$author$project$StageEditor$palletView(model.palletIndex),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('index.html?stage=' + model.stageEncoded)
					]),
				_List_fromArray(
					[
...
var $author$project$StageEditor$main = $elm$browser$Browser$element(
	{init: $author$project$StageEditor$init, subscriptions: $author$project$StageEditor$subscriptions, update: $author$project$StageEditor$update, view: $author$project$StageEditor$view});
_Platform_export({'StageEditor':{'init':$author$project$StageEditor$main(
	A2(
		$elm$json$Json$Decode$andThen,
		function (stage) {
